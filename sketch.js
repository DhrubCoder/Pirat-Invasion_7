...
var bgMusic , waterSound , piratLaughingSound , cannonExplosion ;
...
function preload() {
  ...
  piratLaughingSound = loadSound("assets/pirate_laugh.mp3");
  ...
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      ...
      if (collision.collided && !boats[i].isBroken) {
        if(!isLaughing && !piratLaughingSound.isPlaying()){
          piratLaughingSound.play();
          isLaughing = true;
        }
        isGameOver = true;
        gameOver();
